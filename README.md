...
```shell
yum -y install git wget && git clone https://github.dpik.top/https://github.com/huntersxy/v2board_install.git /usr/local/src/v2board_install && cd /usr/local/src/v2board_install && chmod +x v2board_install.sh && ./v2board_install.sh
```
